...
Additional product details are collected in [docs/README.md](docs/README.md).
...
Each GitHub release provides the web demo as `CascadeScope-web-demo.zip`. Create the release as a draft, attach that ZIP, then publish it. Run the **Deploy release web demo** workflow from the Actions tab and provide the release tag to deploy that asset to GitHub Pages.
